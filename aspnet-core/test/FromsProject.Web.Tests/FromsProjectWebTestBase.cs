...
{
    public abstract class FromsProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static FromsProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(FromsProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<FromsProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<FromsProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<FromsProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<FromsProjectDbContext, Task<T>> func)
        {
            T result;
